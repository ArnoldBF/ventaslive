    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          @if ($selected_id<1)
          <button type="buttom" wire:click.prevent="CreateRole()" class="btn btn-dark close-modal" >GUARDAR</button>
          @else 
          <button type="buttom" wire:click.prevent="UpdateRole()" class="btn btn-dark close-modal">Actualizar</button>   
          @endif
        </div>
      </div>
    </div>
