          ...
          @if($total>0)
           	...
           	<table class="table table-bordered table-striped mt-1">
           		...
           		<tbody>
           			...
           			<tr>
           				...
           				<td>
           					<input type="number" id="r{{$item->id}}" name="" wire:change="updateQty({{$item->id}},$('#r' + {{$item->id}}).val())" style="font-size:1rem!important" class="form-control text-center" value="{{$item->quantity}}">
           				</td>
           ...
           @else
            ...
            <div wire:loading.inline wire:target="saveSale">
            	<h4 class="text-danger text-center">Guardando Venta...
            	</h4>
            </div>
         </div>
     </div>
